...
function Contact(){
    return (
        <main className="contact-container">
            <form action="https://formsubmit.co/1037577e1ba38bca3872f4dcda3a16ab" method="POST" data-redirect="https://camilomedel.github.io/PortfolioPage/" className='animate__animated animate__fadeIn'>
